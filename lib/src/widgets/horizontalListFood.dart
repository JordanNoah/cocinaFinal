...
class HorizontalListFood extends StatefulWidget {
  HorizontalListFood({Key key}) : super(key: key);

  @override
  _HorizontalListFoodState createState() => _HorizontalListFoodState();
}

class _HorizontalListFoodState extends State<HorizontalListFood> {
                            ...
                            Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl: "http://3.23.131.0:3002/"+(mostVotedRecipe[index]["recipe"]["image_recipes"][0]["route"]).replaceAll(r"\",'/'),
