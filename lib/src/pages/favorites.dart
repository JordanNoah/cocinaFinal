...
class _FavoritesState extends State<Favorites> {
  ...
  Future getFavoritesRecipes() async{
    idRecipes.clear();
    try {
      http.Response responseRecipe;
      responseRecipe = await http.get("http://3.23.131.0:3002/api/getMyfavorites?idUser=1");
      ...
      child: Container(
        ...
        child: Card(
          ...
          child: Column(
            children: <Widget>[
              CachedNetworkImage(
                imageUrl: "http://3.23.131.0:3002/"+(recipes[index]["recipe"]["recipe_images"][0]["route"]).replaceAll(r"\",'/'),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text(recipes[index]["recipe"]["title"].toString(),textAlign: TextAlign.left,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
                    SizedBox(height: 5,),
                    ShowRate(countOfReview: recipes[index]["recipe"]["countOfReview"],totalAssessment: recipes[index]["recipe"]["totalAssessment"],)
                  ],
                ),
              )
            ],
