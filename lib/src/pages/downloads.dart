            ...
            if(snapshot.hasData){
              if(snapshot.data.length!=0){
                return GridView.builder(
                  ...
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,crossAxisSpacing: 1,mainAxisSpacing: 6,childAspectRatio: 0.7), 
                                ...
                                children: <Widget>[
                                  ...
                                  Row(
                                    children: <Widget>[
                                      ...
                                      SizedBox(width: 5,),
                                      Text(item.aproxTime,style: TextStyle(color: Colors.grey,fontWeight: FontWeight.bold,fontSize: 10),),
                                    ],
                                  ),
                                ],
                              ),
