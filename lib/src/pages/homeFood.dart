                                                ...
                                                Container(
                                                  ...
                                                  child: Align(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: <Widget>[
                                                        GestureDetector(
                                                          onTap: (){setLiked(recipe[index]["idRecipe"],likedNew.contains(recipe[index]["idRecipe"]));},
                                                          child: Container(
                                                            padding: EdgeInsets.all(10),
                                                            child: Icon(likedNew.contains(recipe[index]["idRecipe"])?Icons.favorite:Icons.favorite_border,
                                                              color: Colors.red,
                                                            ),
                                                          ),
                                                        )
