...
class ClientDatabaseProvider{
  ...
  removeRecipe(int idRecipe) async {
    ...
    var remove = await db.transaction((trc) async{
      var existRecipe = await trc.query("recipes",where: "idRecipe = ?", whereArgs: [idRecipe]);
      if(existRecipe.isNotEmpty){
        var removeRecipe = await trc.delete('recipes',where: "idRecipe = ?", whereArgs: [idRecipe]);
        var removeSteps = await trc.delete("steps_recipes",where: "idRecipe = ?", whereArgs: [idRecipe]);
        //
        var imagesRecipe = await trc.query("image_recipes",where: "idRecipe = ?", whereArgs: [idRecipe]);
        //
        var removeImage = await trc.delete("image_recipes",where: "idRecipe = ?", whereArgs: [idRecipe]);
        var removeIngredientsRecipe = await trc.delete("recipe_ingredients",where: "idRecipe = ?", whereArgs: [idRecipe]);
